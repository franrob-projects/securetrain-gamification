...
export default function HelpPage() {
        ...
        <div className="flex gap-12 flex-col lg:flex-row">
          ...
          <article className="flex-1 max-w-2xl prose-conply">
            ...
            <section id="security">
              ...
              <p>
                If you require a data processing agreement (DPA) or have specific security questions, <a href="mailto:francisroberts@live.com">contact us</a>.
              </p>
            </section>
  ...
  WHERE email = 'you@yourfirm.com';`}</code></pre>
            ...
            <section id="faq">
              ...
              <p>
                Custom branding is part of the Enterprise tier. <a href="mailto:francisroberts@live.com">Get in touch</a> and we&apos;ll discuss what you need.
              </p>
              ...
              <p>
                <a href="mailto:francisroberts@live.com">Email us</a>. There&apos;s no contractual minimum on the Starter or Team tiers — cancel any time. Your audit trail remains accessible for 90 days after cancellation in case you need to produce records during a regulator transition.
              </p>
            </section>
            ...
            <p>
              Still stuck? <a href="mailto:francisroberts@live.com">Email us</a> and we&apos;ll help you get up and running.
            </p>
          </article>
        </div>
      </main>
