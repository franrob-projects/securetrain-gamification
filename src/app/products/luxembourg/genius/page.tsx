...
export const metadata: Metadata = {
  ...
  description: 'Role-mapped compliance training for Luxembourg-regulated CASPs, fintechs, and investment funds. MiCA, AML/CFT, DORA. Adaptive scenarios and individual compliance roadmaps.',
}
...
const FEATURES = [
  ...
  { icon: GitBranch,  title: 'Topic-level regulation mapping', desc: 'Regulation chunks are mapped to individual topics. The system knows exactly which articles of MiCA, the AML Law, or DORA each user has been tested on.', color: '#a78bfa', bg: 'rgba(167,139,250,0.1)', border: 'rgba(167,139,250,0.25)' },
        ...
        <section className="max-w-6xl mx-auto px-6 pt-16 sm:pt-24 pb-16 sm:pb-20">
          <div className="max-w-3xl">
            ...
            <p className="text-base sm:text-lg leading-relaxed mb-8 max-w-2xl" style={{ color: 'var(--muted)' }}>
              Genius maps regulation topics directly to each user&apos;s role. An RC at a CSSF-authorised CASP gets MiCA, AML/CFT, and DORA modules. A KYC analyst gets CDD, RBE verification, and EDD training. A board member gets governance and fit-and-proper obligations.
            </p>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px]" style={{ color: 'var(--muted)' }}>RC, CSSF-authorised CASP</p>
                      </div>
                    </div>
                    <div className="space-y-1.5">
                      {[
                        { label: 'AML/CFT', status: 'completed', score: '100%' },
                        { label: 'MiCA Travel Rule', status: 'completed', score: '67%' },
                        { label: 'DORA', status: 'in-progress', score: '' },
                        { label: 'Sanctions', status: 'not-started', score: '' },
                      ].map(m => (
                ...
                <div className="rounded-xl p-5 relative overflow-hidden" style={{ background: 'var(--card)', border: '1px solid rgba(251,191,36,0.3)', boxShadow: '0 0 30px -8px rgba(251,191,36,0.1)' }}>
                  ...
                  <div className="relative space-y-3">
                    ...
                    <div className="flex items-center gap-2 text-[10px]" style={{ color: 'var(--muted)' }}>
                      ...
                      User completed AML/CFT at 100%, skip basic CDD scenarios
                    </div>
                    <div className="flex items-center gap-2 text-[10px]" style={{ color: 'var(--muted)' }}>
                      <ArrowRight className="w-3 h-3" style={{ color: '#fbbf24' }} />
                      MiCA Travel Rule score was 67%, retrieve Article 72 edge cases
                    </div>
                    <div className="flex items-center gap-2 text-[10px]" style={{ color: 'var(--muted)' }}>
                      <ArrowRight className="w-3 h-3" style={{ color: '#fbbf24' }} />
                      DORA in progress, target Chapter II governance gaps
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-xl p-5" style={{ background: 'var(--card)', border: '1px solid rgba(74,222,128,0.2)' }}>
                  ...
                  <div className="rounded-lg p-3" style={{ background: 'var(--bg)', border: '1px solid var(--card-border)' }}>
                    <p className="text-xs leading-relaxed mb-2" style={{ color: 'var(--text)' }}>
                      Elise, as RC at a CSSF-authorised CASP you discover a €25,000 stablecoin transfer to a self-hosted wallet with no originator info. What should you do first?
                    </p>
                    <div className="space-y-1">
                      {['A. Flag and continue processing', 'B. Suspend transfer and apply EDD', 'C. Report directly to CRF', 'D. Request originator info in 30 days'].map((o, i) => (
                  ...
                  <div className="mt-3 flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-medium" style={{ color: '#4ade80' }}>Tailored to Elise&apos;s RC role + CASP sector</span>
                  </div>
                </div>
              </div>
